...
class StartQueueProcessing
{
    ...
    private $command      = "cd ~/www/dev.sky-network.pro/api/courier_rec_center/amoCRM/cnk-amocrm-sipuni-autocall/cnk-amocrm-sipuni-autocall-gateway && php artisan queue:work --stop-when-empty";
